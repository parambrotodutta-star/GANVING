...
body{background:var(--blk);color:var(--ww);transition:background .4s,color .4s;font-family:'DM Sans',sans-serif;overflow-x:hidden;max-width:100vw;width:100%;}
...
/* ═══════════════════════════════════════════════════
   ...
   Tested: 320px (iPhone SE) to 768px (iPad)
═══════════════════════════════════════════════════ */
...
@media(max-width:980px){
  ...
  .ht-sm{font-size:clamp(.65rem,2vw,.85rem);letter-spacing:.08em}
  .ht-it{font-size:clamp(1.2rem,4vw,2rem);margin-top:.2rem}

  .h-meta{
    display:grid;grid-template-columns:1fr 1fr;
    gap:1rem 1.5rem;margin:1.4rem 0 2rem;padding-top:1rem;
  }
  .hm-sep{display:none}

  section{padding:4.5rem 5vw}
  .vg,.cg{grid-template-columns:1fr;gap:2.5rem}
...
@media(max-width:560px){
  /* Nav: compact pill, stays fully on screen */
  nav{
    top:8px;
    padding:.6rem 1rem;
    width:calc(100% - 1rem);
  ...
  .n-logo{font-size:1.1rem;letter-spacing:-.02em}

  /* Hero full height with safe area */
  #hero{
    height:100svh;
    min-height:580px;
    perspective:none; /* disable 3D perspective on mobile — prevents overflow */
  }

  /* Hero content wrapper — tight safe padding */
  .h-wrap{
  ...
  /* Eyebrow pill */
  .h-eye{margin-bottom:1rem;gap:.5rem;flex-wrap:nowrap}
  .h-pill{font-size:.54rem;letter-spacing:.14em;padding:.22rem .65rem}
  .hp-dot{width:4px;height:4px}
  .h-yr{display:none}

  /* ── BRAND NAME: fluid scaling, never clips ── */
  .h-title{
    line-height:1;
    margin-bottom:.7rem;
  ...
  .ht-big{
    /* Key fix: use vw-only sizing so it always fits the viewport */
    font-size:15.5vw;
    ...
    -webkit-background-clip:text;-webkit-text-fill-color:transparent;
    background-clip:text;
    /* No overflow clipping — allow gradient text to fill naturally */
    overflow:visible;
    max-width:none;
  ...
  .ht-it{
    font-size:clamp(.95rem,4vw,1.7rem);
    margin-top:.18rem;
    letter-spacing:-.01em;
    display:block;
  ...
  .hm-sep{display:none}
  .hm-l{font-size:.48rem;letter-spacing:.2em}
  .hm-v{font-size:.72rem}
  ...
  .btn-a,.btn-g{
    font-size:.64rem;padding:.72rem 1.5rem;letter-spacing:.09em;
  }

  /* Scroll indicator */
  .h-scr{
    right:4vw;bottom:2rem;
    opacity:.6!important;transform:none!important;transition:none!important;
  }

  /* Letterbox bars: disable on mobile (they cause layout issues) */
  ...
  .gal{height:160px}
  .mt{font-size:.62rem;padding:.4rem .85rem;letter-spacing:.07em}
  .mtabs{gap:.3rem;margin:1.6rem 0 2rem;flex-wrap:wrap}
  .rcard{padding:1.4rem 1.4rem}
  .cg{gap:2rem}
  .mpbox{min-height:200px;padding:2rem 1.5rem}
  .gal img:hover{flex:2.5}
  .mq-item{font-size:.64rem;padding:0 1.4rem}
  .rstrip{height:300px}
  .rs-q{font-size:clamp(1.3rem,5.5vw,2rem)}
  footer{padding:2rem 1.5rem}
  .fl{font-size:1.55rem}

  /* Fix vibe section card width */
  .vc{padding:1.2rem}
  .vi-b{left:.8rem;right:.8rem;bottom:.8rem}

  /* Contact section */
  #contact .crow{gap:.7rem}
  #contact .cico{width:34px;height:34px;flex-shrink:0}
  #contact .cval{font-size:.82rem}
}

/* ── Small phones ≤ 390px (iPhone 14, SE etc) ── */
@media(max-width:390px){
  .ht-big{font-size:14.5vw;letter-spacing:-.05em}
  .ht-it{font-size:3.8vw}
  .h-pill{font-size:.52rem;padding:.2rem .6rem}
  .btn-a,.btn-g{padding:.65rem 1.3rem;font-size:.6rem}
  .h-meta{gap:.5rem .8rem}
...
@media(max-width:320px){
  .ht-big{font-size:13.5vw;letter-spacing:-.05em}
  .ht-it{font-size:3.5vw}
  .h-eye{margin-bottom:.8rem}
  .h-meta{grid-template-columns:1fr;gap:.5rem}
  .btn-a,.btn-g{padding:.6rem 1.1rem;font-size:.58rem;width:100%}
...
<style>
/* ── MOBILE: disable ALL reveal animations — show content immediately ── */
@media(max-width:560px){
  /* Kill scroll reveal opacity on mobile — JS will add .on instantly anyway */
  [data-r]{
    opacity:1!important;
    transform:none!important;
    transition:none!important;
  ...
  section, .rstrip, .mq-wrap, .gal, footer{
    opacity:1!important;
...
<noscript><style>
  ...
  #app{opacity:1!important;transform:none!important}
    ...
    <div class="cg">
      <div>
        ...
        <div data-r data-d="2">
          ...
          <div class="crow"><div class="cico">&#x2709;&#xFE0F;</div><div><div class="clbl">Email</div><div class="cval"><a href="/cdn-cgi/l/email-protection#5038353c3c3f1037313e26393e377e393e"><span class="__cf_email__" data-cfemail="38505d545457785f59564e51565f165156">[email&#160;protected]</span></a></div></div></div>
        </div>
        <div data-r data-d="3">
          <table class="htbl">
